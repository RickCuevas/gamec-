...
class T_VIEW_EXPORT place_indexView : public TActionView
{
  Q_OBJECT
public:
  Q_INVOKABLE
  place_indexView() : TActionView() { }
  QString toString();
};

QString place_indexView::toString()
{
  ...
  responsebody += QVariant(linkTo("Create a new Place", urla("create"))).toString();
  responsebody += QLatin1String("<br />\n<br />\n<table border=\"1\" cellpadding=\"5\" style=\"border: 1px #d0d0d0 solid; border-collapse: collapse;\">\n  <tr>\n    <th>ID</th>\n    <th>Space</th>\n    <th>Name</th>\n    <th>Url</th>\n  </tr>\n");
  tfetch(QList<Place>, placeList);
  for (const auto &i : placeList) {
...
T_DEFINE_VIEW(place_indexView)

#include "place_indexView.moc"
