...
class T_VIEW_EXPORT game_indexView : public TActionView
{
  Q_OBJECT
public:
  Q_INVOKABLE
  game_indexView() : TActionView() { }
  QString toString();
};

QString game_indexView::toString()
{
  ...
  responsebody += QVariant(linkTo("Create a new Game", urla("create"))).toString();
  responsebody += QLatin1String("<br />\n<br />\n<table border=\"1\" cellpadding=\"5\" style=\"border: 1px #d0d0d0 solid; border-collapse: collapse;\">\n  <tr>\n    <th>ID</th>\n  </tr>\n");
  tfetch(QList<Game>, gameList);
...
T_DEFINE_VIEW(game_indexView)

#include "game_indexView.moc"
