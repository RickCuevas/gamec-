...
QT_MOC_LITERAL(7, 44, 6) // "remove"
    ...
    "PlayerController\0index\0\0show\0id\0create\0"
    "save\0remove"
};
...
void PlayerController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { PlayerController *_r = new PlayerController();
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        default: break;
        }
    } else if (_c == QMetaObject::InvokeMetaMethod) {
        PlayerController *_t = static_cast<PlayerController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject PlayerController::staticMetaObject = {
    { &ApplicationController::staticMetaObject, qt_meta_stringdata_PlayerController.data,
      qt_meta_data_PlayerController,  qt_static_metacall, nullptr, nullptr}
};
