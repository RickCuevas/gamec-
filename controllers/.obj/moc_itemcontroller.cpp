...
struct qt_meta_stringdata_ItemController_t {
    QByteArrayData data[8];
    char stringdata0[49];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ItemController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ItemController_t qt_meta_stringdata_ItemController = {
    {
QT_MOC_LITERAL(0, 0, 14), // "ItemController"
...
QT_MOC_LITERAL(7, 42, 6) // "remove"
    ...
    "ItemController\0index\0\0show\0id\0create\0"
    "save\0remove"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ItemController[] = {
...
void ItemController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { ItemController *_r = new ItemController();
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        default: break;
        }
    } else if (_c == QMetaObject::InvokeMetaMethod) {
        ItemController *_t = static_cast<ItemController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ItemController::staticMetaObject = {
    { &ApplicationController::staticMetaObject, qt_meta_stringdata_ItemController.data,
      qt_meta_data_ItemController,  qt_static_metacall, nullptr, nullptr}
};
...
void *ItemController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ItemController.stringdata0))
